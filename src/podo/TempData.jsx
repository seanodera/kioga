let works = [{
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id nibh ultrices, maximus diam et, hendrerit nisi. Suspendisse molestie dolor vitae dui feugiat, quis eleifend lectus fermentum. Donec ac lorem enim. Phasellus eget massa elit. Donec ut libero tempor, pretium mauris feugiat, aliquam dolor. Vestibulum vestibulum justo nec sem auctor rutrum. Integer tempus malesuada augue, et consectetur ex accumsan vitae. Vestibulum ut neque elit. Nunc pulvinar cursus felis, id pulvinar metus lacinia vel. Mauris iaculis sem eget metus efficitur, dignissim convallis orci malesuada. Maecenas finibus urna vel eros ullamcorper, ac ultricies tellus luctus. Etiam egestas enim felis, non laoreet turpis sollicitudin sit amet. Sed egestas turpis sit amet vehicula imperdiet. Pellentesque leo metus, interdum sit amet molestie non, commodo non purus.',
    id: 0,
    type: 'road'
}, {
    image: '/assets/image2.jpg',
    name: 'Road Upgrade',
    description: 'Vivamus hendrerit mattis mattis. In a nunc non metus pellentesque dapibus. Pellentesque et auctor diam. Aliquam porttitor augue vel nisl vehicula, cursus volutpat purus pulvinar. Morbi ut consectetur lectus. Nullam facilisis aliquam leo eu luctus. Aliquam fringilla, massa sit amet pulvinar placerat, eros nunc eleifend risus, eu faucibus risus metus non neque. Donec at iaculis mauris. Quisque rutrum enim diam, at auctor nibh scelerisque sed.',
    id: 1,
    type: 'repair'
}, {
...
let colors = ['#76ff03', '#1DE9B6', '#FF1744',
    '#00E5FF', '#C6FF00', '#FFC400',
    '#FF9100', '#FF3d00', '#F50057','#76ff03', '#1DE9B6', '#FF1744',
    '#00E5FF', '#C6FF00', '#FFC400',
